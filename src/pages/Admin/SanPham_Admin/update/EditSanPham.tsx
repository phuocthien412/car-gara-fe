...
export default function EditSanPham() {
  ...
  return (
    <div className="min-h-[80vh] rounded-xl bg-neutral-950 text-neutral-100 p-4 sm:p-6 shadow-inner border border-neutral-800">
      <div className="mb-4 text-lg sm:text-2xl font-semibold">Sửa sản phẩm</div>
      <form onSubmit={onSubmit} className="space-y-4 rounded-lg border border-neutral-800 bg-neutral-900/60 p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 gap-3">
          {/* image component stacked on mobile */}
        ...
        <div className="flex flex-col md:flex-row gap-3 md:gap-2">
          ...
          <button type="button" onClick={() => navigate(PATH.ADMIN_SAN_PHAM)} className="w-full md:w-auto rounded-lg bg-neutral-800 px-4 py-2 text-neutral-200 border border-neutral-700 hover:bg-neutral-800/70">
            Hủy
          </button>
        </div>
      </form>
